...
from NeuroCore.Models.CableModel.Passive.Stationary import PassiveCableModel
...
from Analytics.Solutions.CableModel.passiveCableModel import CableModel
...
analytical = CableModel(domain=simDomain,steps=simSteps,\
...
simModel = PassiveCableModel(iApproximation=GalerkinApproximation(),\
